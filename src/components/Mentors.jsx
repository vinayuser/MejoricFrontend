...
import { FaRocket, FaClock, FaBell } from "react-icons/fa";
        ...
        <div className="min-h-screen from-purple-50 via-pink-50 to-purple-100 flex items-center justify-center px-4 py-16">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 text-lg mb-8 max-w-lg mx-auto leading-relaxed">
              Our team of expert mentors is coming soon to help you achieve your
              goals. Get ready for personalized guidance and support on your
              journey to success.
            </p>
            ...
            <button
              type="button"
              className="bg-purple-600 text-white px-10 py-4 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-3 mx-auto"
            >
              <FaBell />
